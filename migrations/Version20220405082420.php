 ...
 */
final class Version20220405082420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE couleur DROP vehicule_id, CHANGE couleur nom VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE couleur ADD vehicule_id INT DEFAULT NULL, ADD couleur VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP nom');
